...
func main() {
	...
	if generate {
		err = Generate(repos, permissiondetails, useAllPermissionTargetsAsSource, onlyGenerateMatchingRepos, onlyGenerateCleanRepos, combineRepos, allowRenamedPermissions, split, repofiles[0], generateyaml)
		if err != nil {
